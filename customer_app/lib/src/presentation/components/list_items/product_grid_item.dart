  ...
  Widget build(BuildContext context) {
    ...
    final String price = NumberFormat.currency(
      symbol: LocalStorage.instance.getSelectedCurrency()?.symbol,
        ...
        ? ((product.stocks?.first.price ?? 0) - (product.stocks?.first.discount ?? 0))
          ...
          SizedBox(
            ...
            child: Stack(
              children: [
                ...
                if(product.stocks?.first.discountExpired?.isNotEmpty ?? false) Positioned(
                  bottom: 8.r,
                  right: 8.r,
                  child: Container(
                   ...
                   // margin: EdgeInsets.only(left: 60.r, bottom: 8.r, right: 15.r),
                    child: Row(
                      children: [
                        Icon(Icons.access_time_outlined, color: AppColors.white,size: 16.sp,),
                        6.horizontalSpace,
                        Text(product.stocks?.first.discountExpired ?? '',
