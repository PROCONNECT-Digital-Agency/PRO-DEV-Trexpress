...
class ProductItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool hasDiscount = product?.stocks?.isNotEmpty ?? false ? product?.stocks?.first.discount != null &&
        (product?.stocks?.first.discount ?? 0) > 0 : false;
    return Container(
            ...
            Row(
              children: [
                Text(
                  ...
                  ).format(product?.stocks?.isNotEmpty ?? false ? (hasDiscount
