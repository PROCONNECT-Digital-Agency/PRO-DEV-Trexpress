...
/// @nodoc
abstract class _$$_NewAddressStateCopyWith<$Res>
    implements $NewAddressStateCopyWith<$Res> {
  factory _$$_NewAddressStateCopyWith(
          _$_NewAddressState value, $Res Function(_$_NewAddressState) then) =
      __$$_NewAddressStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool isLoading,
...
/// @nodoc
class __$$_NewAddressStateCopyWithImpl<$Res>
    extends _$NewAddressStateCopyWithImpl<$Res, _$_NewAddressState>
    implements _$$_NewAddressStateCopyWith<$Res> {
  __$$_NewAddressStateCopyWithImpl(
      _$_NewAddressState _value, $Res Function(_$_NewAddressState) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_NewAddressState(
      isLoading: null == isLoading
          ? _value.isLoading
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$_NewAddressState extends _NewAddressState {
  const _$_NewAddressState(
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_NewAddressStateCopyWith<_$_NewAddressState> get copyWith =>
      __$$_NewAddressStateCopyWithImpl<_$_NewAddressState>(this, _$identity);
}
...
abstract class _NewAddressState extends NewAddressState {
  const factory _NewAddressState(
      ...
      final String male,
      final String passportPrefix,
      final TextEditingController? addressController}) = _$_NewAddressState;
