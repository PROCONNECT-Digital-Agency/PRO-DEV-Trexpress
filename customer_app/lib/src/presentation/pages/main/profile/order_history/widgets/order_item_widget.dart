                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            '${AppHelpers.getTranslation(TrKeys.order)} ${AppHelpers.getTranslation(TrKeys.status)}: ${order.status}',
                            style: GoogleFonts.k2d(
                              fontWeight: FontWeight.w500,
                              fontSize: 13.sp,
                              letterSpacing: -14 * 0.01,
                          ...
                          Text(
                            '${AppHelpers.getTranslation(TrKeys.payment)} ${AppHelpers.getTranslation(TrKeys.status)}: ${AppHelpers.getTranslation(order.transaction?.status ?? "no_payment")}',
                            style: GoogleFonts.k2d(
                              fontWeight: FontWeight.w500,
                              fontSize: 13.sp,
                              letterSpacing: -14 * 0.01,
