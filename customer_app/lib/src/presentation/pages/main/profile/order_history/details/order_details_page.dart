                              ...
                              children: [
                                ...
                                if (state.orderResponse?.data?.transaction
                                    ...
                                    state.orderResponse?.data?.transaction
                                            ?.paymentSystem?.tag ==
                                        'atb' &&
                                    state.orderResponse?.data?.status?.toUpperCase() !=
                                        "CANCELED")
                                  Padding(
            ...
            children: [
              Expanded(
                child: AccentLoginButton(
                  ...
                  onPressed: state.orderResponse?.data?.status?.toUpperCase() == "NEW"
                      ? () => {
                            ref
                                .read(orderDetailsProvider.notifier)
                                .cancelOrder(context)
              ...
              Expanded(
                child: AccentLoginButton(
                  ...
                  onPressed: state.orderResponse?.data?.status?.toUpperCase() == "DELIVERED"
                      ? () {
