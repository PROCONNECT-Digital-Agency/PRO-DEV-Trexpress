  ...
  Widget build(BuildContext context) {
    ...
    return ModalWrap(
      body: Container(
        ...
        child: state.isDetailLoading ? JumpingDots(color: isDarkMode ? AppColors.white : AppColors.black) : SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: GoogleFonts.k2d(fontSize: 26.sp, color: isDarkMode
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: GoogleFonts.k2d(fontSize: 14.sp, color: isDarkMode
                      ? AppColors.white.withOpacity(0.8)
                    : AppColors.black,),
                ),
              ),
              ...
              Padding(
                ...
                child:  Html(
                  data:
                  state.notificationDetail?.translation?.description ??
                      "",
                ),
              ),
              24.verticalSpace,
