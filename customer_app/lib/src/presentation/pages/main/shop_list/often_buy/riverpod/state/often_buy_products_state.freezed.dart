...
part of 'often_buy_products_state.dart';
...
mixin _$OftenBuyProductsState {
  ...
  @JsonKey(ignore: true)
  $OftenBuyProductsStateCopyWith<OftenBuyProductsState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OftenBuyProductsStateCopyWith<$Res> {
  factory $OftenBuyProductsStateCopyWith(OftenBuyProductsState value,
          $Res Function(OftenBuyProductsState) then) =
      _$OftenBuyProductsStateCopyWithImpl<$Res, OftenBuyProductsState>;
  @useResult
  $Res call(
      {bool isLoading,
      bool isMoreLoading,
...
/// @nodoc
class _$OftenBuyProductsStateCopyWithImpl<$Res,
        $Val extends OftenBuyProductsState>
    implements $OftenBuyProductsStateCopyWith<$Res> {
  _$OftenBuyProductsStateCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? selectedSearchCategoryId = null,
    Object? selectedSearchBrandId = null,
    Object? query = null,
    ...
    return _then(_value.copyWith(
      ...
      selectedBrandId: null == selectedBrandId
          ...
          : selectedBrandId // ignore: cast_nullable_to_non_nullable
              as int,
      selectedSearchCategoryId: null == selectedSearchCategoryId
          ? _value.selectedSearchCategoryId
          : selectedSearchCategoryId // ignore: cast_nullable_to_non_nullable
              as int,
      selectedSearchBrandId: null == selectedSearchBrandId
...
/// @nodoc
abstract class _$$_OftenBuyProductsStateCopyWith<$Res>
    implements $OftenBuyProductsStateCopyWith<$Res> {
  factory _$$_OftenBuyProductsStateCopyWith(_$_OftenBuyProductsState value,
          $Res Function(_$_OftenBuyProductsState) then) =
      __$$_OftenBuyProductsStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool isLoading,
...
/// @nodoc
class __$$_OftenBuyProductsStateCopyWithImpl<$Res>
    extends _$OftenBuyProductsStateCopyWithImpl<$Res, _$_OftenBuyProductsState>
    implements _$$_OftenBuyProductsStateCopyWith<$Res> {
  __$$_OftenBuyProductsStateCopyWithImpl(_$_OftenBuyProductsState _value,
      $Res Function(_$_OftenBuyProductsState) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_OftenBuyProductsState(
      isLoading: null == isLoading
          ? _value.isLoading
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$_OftenBuyProductsState extends _OftenBuyProductsState {
  const _$_OftenBuyProductsState(
  ...
  @override
  String toString() {
    return 'OftenBuyProductsState(isLoading: $isLoading, isMoreLoading: $isMoreLoading, isSearching: $isSearching, isSearchLoading: $isSearchLoading, isCategoriesLoading: $isCategoriesLoading, isBrandsLoading: $isBrandsLoading, shops: $shops, searchedCategories: $searchedCategories, products: $products, searchedProducts: $searchedProducts, categories: $categories, brands: $brands, selectedCategoryId: $selectedCategoryId, selectedBrandId: $selectedBrandId, selectedSearchCategoryId: $selectedSearchCategoryId, selectedSearchBrandId: $selectedSearchBrandId, query: $query, listAlignment: $listAlignment)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_OftenBuyProductsState &&
            ...
            (identical(
                ...
                other.selectedSearchCategoryId == selectedSearchCategoryId) &&
            (identical(other.selectedSearchBrandId, selectedSearchBrandId) ||
                other.selectedSearchBrandId == selectedSearchBrandId) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_OftenBuyProductsStateCopyWith<_$_OftenBuyProductsState> get copyWith =>
      __$$_OftenBuyProductsStateCopyWithImpl<_$_OftenBuyProductsState>(
          this, _$identity);
}

abstract class _OftenBuyProductsState extends OftenBuyProductsState {
  const factory _OftenBuyProductsState(
      {final bool isLoading,
      final bool isMoreLoading,
      final bool isSearching,
      final bool isSearchLoading,
      ...
      final int selectedSearchBrandId,
      final String query,
      final ListAlignment listAlignment}) = _$_OftenBuyProductsState;
  const _OftenBuyProductsState._() : super._();
