...
mixin _$MostSoldState {
  ...
  @JsonKey(ignore: true)
  $MostSoldStateCopyWith<MostSoldState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $MostSoldStateCopyWith<$Res> {
  factory $MostSoldStateCopyWith(
          MostSoldState value, $Res Function(MostSoldState) then) =
      _$MostSoldStateCopyWithImpl<$Res, MostSoldState>;
  @useResult
  $Res call(
      {bool isLoading,
      bool isMoreLoading,
...
/// @nodoc
class _$MostSoldStateCopyWithImpl<$Res, $Val extends MostSoldState>
    implements $MostSoldStateCopyWith<$Res> {
  _$MostSoldStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_MostSoldStateCopyWith<$Res>
    implements $MostSoldStateCopyWith<$Res> {
  factory _$$_MostSoldStateCopyWith(
          _$_MostSoldState value, $Res Function(_$_MostSoldState) then) =
      __$$_MostSoldStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool isLoading,
...
/// @nodoc
class __$$_MostSoldStateCopyWithImpl<$Res>
    extends _$MostSoldStateCopyWithImpl<$Res, _$_MostSoldState>
    implements _$$_MostSoldStateCopyWith<$Res> {
  __$$_MostSoldStateCopyWithImpl(
      _$_MostSoldState _value, $Res Function(_$_MostSoldState) _then)
      : super(_value, _then);
...
class _$_MostSoldState extends _MostSoldState {
  const _$_MostSoldState(
  ...
  @override
  String toString() {
    return 'MostSoldState(isLoading: $isLoading, isMoreLoading: $isMoreLoading, isSearching: $isSearching, isSearchLoading: $isSearchLoading, products: $products, searchedProducts: $searchedProducts, query: $query, listAlignment: $listAlignment)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_MostSoldStateCopyWith<_$_MostSoldState> get copyWith =>
      __$$_MostSoldStateCopyWithImpl<_$_MostSoldState>(this, _$identity);
}

abstract class _MostSoldState extends MostSoldState {
  const factory _MostSoldState(
      {final bool isLoading,
      final bool isMoreLoading,
      final bool isSearching,
      final bool isSearchLoading,
      ...
      final String query,
      final ListAlignment listAlignment}) = _$_MostSoldState;
  const _MostSoldState._() : super._();
