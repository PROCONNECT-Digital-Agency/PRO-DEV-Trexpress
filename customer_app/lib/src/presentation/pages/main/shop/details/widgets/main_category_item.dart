...
class MainCategoryItem extends ConsumerWidget {
  ...
  const MainCategoryItem({Key? key, required this.category, this.index}) : super(key: key);
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.builder(
            ...
            primary: false,
            itemCount:
                AppHelpers.getSubCategoriesLength(category.children?.length ?? 0 , index),
              ...
              return Material(
                ...
                child: InkWell(
                  ...
                  onTap: () => context.pushRoute(
                    CategoryProductsRoute(category: subCategory, title: subCategory?.translation?.title ??
